...
class ConditionalEncoder(nn.Module):
    def __init__(self, input_channels, num_classes, latent_dim):
        super().__init__()
        self.conv1 = nn.Conv2d(input_channels + num_classes, 32, 4, 2, 1)
...
class ConditionalDecoder(nn.Module):
    def __init__(self, latent_dim, num_classes, output_channels):
        ...
        self.deconv1 = nn.ConvTranspose2d(128, 64, 4, 2, 2)
        self.deconv2 = nn.ConvTranspose2d(64, 32, 4, 2, 1)
        self.deconv3 = nn.ConvTranspose2d(32, output_channels, 4, 2, 1)
...
def train(args):
    ...
    torch.save(model.decoder.state_dict(), os.path.join(args.model_dir, "decoder.pth"))
